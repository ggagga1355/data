...
# ex) 'app_user'@'192.1.1.2' -> 192.1.1.2에서만 접속 가능
# identified by '비밀번호' -> 계정을 만들 수 있음
...
create table TBL_MEMBER( 
	name varchar(30), -- 문자열 데이터만 들어갈 수 있다.
...
create table ex01(
	...
	col2 varchar(10),
	create_date DATETIME default CURRENT_TIMESTAMP() #현재시간을 찍어주는 함수
);
...
#컬럼명 바꾸기
alter table ex01 rename column first_co1 to first_col;
